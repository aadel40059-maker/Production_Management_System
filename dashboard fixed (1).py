...
if page == "الرئيسية":
    ...
    st.markdown(
        f"""
        <div style="margin-top:8px; padding:14px 18px; background:linear-gradient(90deg,#f8fafc,#eef2f7);
                    border-right:4px solid #16a34a; border-radius:8px;">
            <div style="font-size:13px; color:#374151;">✅ تم الاعتماد من قبل مديري صيانة مصنع 1 و 2</div>
            <div style="font-family:'Segoe Script','Brush Script MT',cursive; font-style:italic; font-size:22px;
                        color:#0b1f3a; margin-top:4px; letter-spacing:0.5px;">
                {FACTORY_CONFIG['مصنع 1']['maint_name']} &nbsp;&amp;&nbsp; {FACTORY_CONFIG['مصنع 2']['maint_name']}
            </div>
        </div>
        """,
    ...
    signature_html = f"""
    <div style="margin-top:10px; padding:12px 16px; background:linear-gradient(90deg,#f8fafc,#eef2f7);
                border-right:4px solid #16a34a; border-radius:8px; page-break-inside:avoid;">
        <div style="font-size:11px; color:#374151;">✅ تم الاعتماد من قبل مديري صيانة مصنع 1 و 2</div>
        <div style="font-family:'Segoe Script','Brush Script MT',cursive; font-style:italic; font-size:18px;
    ...
    daily_single_page_height_mm = (
        ...
        + (280 * len(FACTORY_CONFIG))  # صور الرسوم البيانية (٤ صور: بار + ترند لكل مصنع)
        + (len(reasons_df) * 6)
        + (len(notes_list) * 6)
        + 50  # الإمضاء
    )
