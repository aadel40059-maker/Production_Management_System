...
if page == "الرئيسية":
    ...
    daily_report_df["الحالة"] = daily_report_df["الحالة"].replace("", STATUS_PENDING).fillna(STATUS_PENDING)
    daily_report_df["معتمد بواسطة"] = daily_report_df["معتمد بواسطة"].replace("", "-").fillna("-")
    daily_report_df = daily_report_df[[
        "الخط", "اسم الماكينة", "الوردية", "من الساعة", "إلى الساعة", "مدة العطل (دقيقة)", "سبب العطل",
        "الحالة", "تكلفة الصيانة (جنيه)", "معتمد بواسطة",
    ]]
