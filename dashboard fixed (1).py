...
def build_dashboard_document(overall_title, overall_subtitle, sections):
    ...
    أي اعتماد على إنترنت أو مكتبات خارجية) وتنفع كمان تتحول PDF من المتصفح (Ctrl+P). لو الأقسام أكتر من واحد،
    كل قسم بيبدأ في صفحة جديدة عند الطباعة — وده اللي بيتستخدم في خاصية 'البورتفوليو الشهري'.
    ...
    for i, sec in enumerate(sections):
        ...
        page_break_class = "" if i == 0 else "page-break"
        blocks.append(f"""
        <div class="report-page {page_break_class}">
    ...
    <style>
        ...
        * {{ box-sizing: border-box; }}
        ...
        .report-page {{ margin-bottom: 22px; }}
