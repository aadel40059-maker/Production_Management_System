...
if page == "الرئيسية":
    ...
    def _dual_line_trend_fig(days, top_series, bottom_series, top_title, bottom_title,
                              top_color_top=None, bottom_neg_color="#dc2626", figsize=(4.8, 4.4)):
        ...
        if not gsheet_exists("breakage_history"):
            ...
            if break_month_r.empty:
                ...
                if has_break_trend:
                    ...
                    fig_break_trend_only, ax_bt = plt.subplots(figsize=(4.8, 2.6), dpi=140)
                ...
                if has_break_trend:
                    fig_break_trend_p, ax_btp = plt.subplots(figsize=(4.8, 2.6), dpi=140)
        ...
        if not gsheet_exists("faults_daily_log"):
            ...
            if faults_month_r.empty:
                ...
                def _build_faults_line_trend_fig():
                    fig_flt, ax_flt = plt.subplots(figsize=(4.8, 2.6), dpi=140)
