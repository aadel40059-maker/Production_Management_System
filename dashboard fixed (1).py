...
def build_printable_html(title, subtitle, df, extra_title=None, extra_df=None, extra_tables=None,
    ...
    <style>
        ...
        * {{ box-sizing: border-box; }}
        ...
        table:not(.layout-wrapper) {{ border-collapse: collapse; width: 100%; font-size: {base_font_size}px; page-break-inside: avoid; }}
        table:not(.layout-wrapper) th, table:not(.layout-wrapper) td {{
            border: 1px solid #d1d5db; padding: {"2px 3px" if compact else "3px 5px"}; text-align: center;
        }}
