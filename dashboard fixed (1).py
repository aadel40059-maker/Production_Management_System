...
if page == "الرئيسية":
    ...
    st.caption(
        "ملف HTML واحد بتصميم لوحة تحكم احترافية زي التقارير فوق — كل تقرير في صفحة لوحده. "
        "تقدر تنشره كصفحة ويب مستقلة (مفيهوش أي اعتماد على إنترنت)، أو تفتحه وتدوس Ctrl+P وتحفظه PDF"
    )
    ...
    if not report_parts:
        ...
        if chosen_keys_r:
            ...
            st.download_button(
                ...
                mime="text/html",
                help="ملف HTML واحد بتصميم لوحة تحكم احترافية — كل تقرير في صفحة، تقدر تنشره على أي موقع "
