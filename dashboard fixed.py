...
if page == "Dashboard":
    ...
    if allow_log:
        ...
        if st.button("💾 تسجيل عطل خطي اليوم"):
            ...
            DAILY_LOG_FILE = "faults_daily_log.csv"
            if os.path.exists(DAILY_LOG_FILE):
                daily_log = pd.read_csv(DAILY_LOG_FILE)
            else:
            ...
            daily_log.to_csv(DAILY_LOG_FILE, index=False)
    ...
    DAILY_LOG_FILE = "faults_daily_log.csv"
    if os.path.exists(DAILY_LOG_FILE):
        daily_log_all = pd.read_csv(DAILY_LOG_FILE, dtype=str)
