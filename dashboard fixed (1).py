...
if st.session_state.app_theme == "light":
    ...
    .stApp { background-color: #fffbea; color: #013e37; }
    [data-testid="stSidebar"] { background-color: #013e37; }
    [data-testid="stSidebar"] * { color: #ffefb3 !important; }

    .stButton>button, .stDownloadButton>button {
        background-color: #013e37; color: #ffefb3 !important; border: 2px solid #013e37;
        border-radius: 8px; font-weight: 800; padding: 9px 20px; font-size: 16px;
    }
    .stButton>button:hover, .stDownloadButton>button:hover { filter: brightness(1.25); color:#ffefb3 !important; }

    [data-testid="stMetric"] {
        background-color: #ffefb3; border: 2px solid #013e37;
        border-radius: 12px; padding: 16px 18px; box-shadow: 0 1px 3px rgba(1,62,55,0.15);
    }
    [data-testid="stMetricLabel"] { color: #013e37 !important; font-weight: 700 !important; }
    [data-testid="stMetricValue"] { color: #013e37 !important; font-weight: 800 !important; }

    h1, h2, h3 { font-weight: 800; letter-spacing: -0.3px; color: #013e37 !important; }
    p, span, label, div, li { font-weight: 600; color: #013e37; }

    /* تكبير الخط العام شوية في كل الصفحة */
    html, body, [class*="css"], .stMarkdown, .stText, .stDataFrame, [data-testid="stWidgetLabel"] p {
        font-size: 17px !important;
    }
    [data-testid="stDataFrame"] { font-weight: 600; }
    ...
    [data-testid="stSidebar"] [data-testid="stRadio"] label {
        ...
        padding: 11px 14px;
        border-radius: 8px;
        background-color: rgba(255,239,179,0.12);
        margin-bottom: 4px;
        font-weight: 800;
        font-size: 16px;
        cursor: pointer;
    ...
    [data-testid="stSidebar"] [data-testid="stRadio"] label:hover {
        background-color: rgba(255,239,179,0.24);
    }
    ...
    .stApp { background-color: #012620; color: #ffefb3; }
    ...
    .stButton>button:hover, .stDownloadButton>button:hover { filter: brightness(0.9); color:#013e37 !important; }

    [data-testid="stMetric"] {
        background-color: #013e37; border: 2px solid #ffefb3;
    ...
    h1, h2, h3, p, span, label, .stMarkdown { color: #ffefb3 !important; }
    ...
    [data-testid="stSidebar"] [data-testid="stRadio"] label:hover {
        background-color: rgba(255,239,179,0.18);
    }
    [data-testid="stSidebar"] [data-testid="stRadio"] label:has(input:checked) {
        background-color: #ffefb3;
    }
